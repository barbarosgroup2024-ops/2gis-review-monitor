...
### ⚠️ Важно: Сначала настройте базу данных!

**Перед деплоем выполните:** [SUPABASE_SETUP.md](./SUPABASE_SETUP.md) (5 минут)

Это создаст таблицы в Supabase и настроит безопасность.
...
1. Настройте Supabase: [SUPABASE_SETUP.md](./SUPABASE_SETUP.md)
2. Следуйте инструкции в [QUICK_START_RENDER.md](./QUICK_START_RENDER.md)
3. Добавьте переменные окружения из [RENDER_ENV.txt](./RENDER_ENV.txt)
...
1. Настройте Supabase: [SUPABASE_SETUP.md](./SUPABASE_SETUP.md)
2. Следуйте инструкции в [QUICK_DEPLOY.md](./QUICK_DEPLOY.md)
3. Добавьте переменные окружения из [RAILWAY_ENV.txt](./RAILWAY_ENV.txt)
4. Настройте Telegram webhook
